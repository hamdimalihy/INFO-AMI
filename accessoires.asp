...
<body>
<br><br><br>
	<h1>Espace Matériels Informatiques :</h1>
	<br><br><br>
				...
				<table style="width:100%">
				 ...
				 <%
					Dim con,Req
					Req = "ps_afficher_autre_materiel"
				...
				<tr>
						...
						<td style="text-align:center"><a class="commanderacc" id="<%=Rs("IdProduit")%>" href="commandeaccessoiresForm.asp">Cliquez ici pour commander</a></td>
			   </tr>
				<%
					Rs.MoveNext
					WEnd
